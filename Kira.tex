...
From the analysis and experiments, we believe that the big data ecosystem is a compelling candidate for many-task applications and the high end
HPC platforms are not mandatory for high performance of many-task applications.
\zhaonote{trying to say the point of this work, let me know if this makes sense to you.}
...
So that high end HPC platforms are not mandatory for high performance of many-task applications.
...
to support the many-task applications and the high end HPC platforms are not mandatory to achieve
high performance for many-task applications.
