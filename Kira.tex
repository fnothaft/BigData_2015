...
Our experience with Kira indicates that emerging Big Data platforms such as Apache Spark are an efficient alternative for many-task scientific applications.  \zhaonote{trying to say the point of this work, let me know if this makes sense to you.}
...
Our experience with Kira indicates that emerging Big Data platforms such as Apache Spark are an efficient 
alternative for many-task scientific applications.   Leveraging such platforms would enable scientists to benefit 
from the rapid pace of innovation and wide range of systems and technologies that are being driven by 
wide-spread interest in Big Data analytics.
